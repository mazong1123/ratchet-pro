...
If you really really want mouse events support publicly, call window.RATCHET.Class.PageManager.enableMouseSupport() before  window.RATCHET.Class.PageManager.ready(function() {/*...*/}).
